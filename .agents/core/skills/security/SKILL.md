...
name: security
description: >
  Application and AI agent security skill. Enforces zero-trust defense-in-depth,
  OWASP Top 10 mitigation, prompt injection defense, and secure tool execution.
---
